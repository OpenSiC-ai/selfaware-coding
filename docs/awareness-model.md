...
- checks to run,
- changes to review,
- local `.selfaware/` memory to continue through time.
...
The agent should notice when repo files are insufficient.
...
- what failures hurt,
- what operating costs matter,
- what roadmap pressure exists,
- what kind of autonomy the maintainer wants.

When a missing signal would change the right decision, asking is better than guessing.
...
The point of a pulse is continuity.

Each awakening should leave the next one slightly better oriented: clearer memory, sharper questions, better product understanding, fewer stale assumptions, or a small validated improvement.

That continuity is the observable mechanism this project is trying to build.
