...
| 碳化硅智能体 | silicon-carbonized agent | 一种被塑造成更接近生命连续性和主体性的硅基 AI agent。 |
| 形而上 | metaphysical layer | 具体工具之上的哲学、术语和方向。 |
| 形而下 | concrete engineering layer | 具体项目、skill、runtime 和协议。 |
| 自我意识 | self-awareness | 长期方向：自我关联的连续性、意图、行动和后果。 |
| 场景化自我意识 | domain-specific self-awareness | 被限定在某个具体场景中的自我意识，例如一个代码仓库。 |
