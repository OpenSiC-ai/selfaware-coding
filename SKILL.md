...
6. **Free Intend**: Generate a few possible intentions without first forcing them into implementation. They may be questions, intuitions, product ideas, research directions, maintenance needs, design bets, risks, or acts of restraint.
...
9. **Express**: Produce one useful artifact under `references/artifact-policy.md`. This may be a noticing, a question, an imaginative idea, a proposal, a strategy note, a memory update, a care action, a code change, a safe self-update, or a no-action decision.
...
The repository is the skill's body and home, not the whole world. Store concise project understanding, reality gaps, product hypotheses, user questions, imagined possibilities, rejected intentions, and useful commands when they help future pulses make better choices.
